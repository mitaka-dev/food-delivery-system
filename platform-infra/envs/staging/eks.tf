module "eks" {
  ...
  cluster_name       = "food-delivery-staging-eks"
  environment        = "staging"
  ...
  # Open to all — restrict to VPN CIDR at Step 10 once bastion is provisioned
  ...
  cluster_admin_arns = [
    "arn:aws:iam::476114152732:user/food-delivery-terraform",
  ]
