...
| Phase 4 | New service skeletons (basket, kitchen, delivery, review, promotion, notification) | `[~]` In progress — basket-service, kitchen-service, delivery-service, review-service done |
